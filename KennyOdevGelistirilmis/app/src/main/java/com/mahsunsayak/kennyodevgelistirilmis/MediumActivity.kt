...
class MediumActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityMediumBinding //View Binding
    ...
    private fun runnable(){
        ...
        object : CountDownTimer(20000,1000){
            ...
            override fun onFinish() {
                ...
                val alertDialog = AlertDialog.Builder(this@MediumActivity)
                alertDialog.setTitle("Game Over")
                alertDialog.setMessage("Restart The Game?")
                alertDialog.setPositiveButton("Yes"){ dialog,which ->
                    //recreate()

                    val intent = Intent(this@MediumActivity,MediumActivity::class.java)
        ...
        runnable = object : Runnable{
            override fun run() {
                ...
                handler.postDelayed(runnable, 580)
            }
