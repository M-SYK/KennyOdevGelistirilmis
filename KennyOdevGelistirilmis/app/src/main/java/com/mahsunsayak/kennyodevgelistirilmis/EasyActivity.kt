...
import com.mahsunsayak.kennyodevgelistirilmis.databinding.ActivityEasyBinding
...
class EasyActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityEasyBinding //View Binding
    ...
    var score = 0 //Kullanıcı Kenny'e her dokunuşunda skoru artırmak için değişken tanımlandı.
    ...
    private fun runnable(){
        ...
        object : CountDownTimer(20000,1000){
            ...
            override fun onFinish() {
                ...
                val alertDialog = AlertDialog.Builder(this@EasyActivity)
                alertDialog.setTitle("Game Over")
                alertDialog.setMessage("Restart The Game?")
                alertDialog.setPositiveButton("Yes"){ dialog,which ->

                    //recreate()
                    val intent = Intent(this@EasyActivity,EasyActivity::class.java)
